...
const variantStyles = {
  ...
  "dark-red": {
    ...
    expandIcon: "bg-[#8B0000]/10 text-[#8B0000]",
    badge: "bg-gradient-to-br from-orange-50 to-white text-[#8B0000] border-[#8B0000]/10",
    link: "bg-gradient-to-br from-[#8B0000] to-[#4B0000]",
